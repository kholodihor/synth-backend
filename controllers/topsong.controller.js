...
const addTopSong = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
const getTopSongs = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const songs = yield topsong_model_1.default.find();
